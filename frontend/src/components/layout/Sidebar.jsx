...
import { AdminProfileModal } from '../pages/AdminProfileModal';
...
function Sidebar() {
  ...
  return (
    // FIX: Wrapped everything in a single parent fragment <>...</>
    <>
      <motion.aside
            ...
            <AnimatePresence>
              {!state.sidebarCollapsed && (
                <motion.div
                  ...
                  animate="expanded"
                  exit="collapsed"
                  className="mb-3 p-2 bg-sidebar-accent rounded-lg cursor-pointer hover:bg-opacity-80 transition-opacity"
                >
